...
def get_database_connection():
    ...
    if 'db' not in g:
        ...
        g.db.row_factory = sqlite3.Row  # Enable row factory for dictionary-like access
    return g.db
...
def init_database(app=None):
    """Initialize the database and register with Flask app if provided."""
    ...
    # If Flask app is provided, register the teardown
    if app:
